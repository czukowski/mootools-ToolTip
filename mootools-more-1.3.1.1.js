...
// Load this file's selection again by visiting: http://mootools.net/more/7caa68aeeaa81fb5b5a51eadbd1ed6e4 
// Or build this file again with packager using: packager build More/Element.Position More/Element.Shortcuts More/Assets More/Locale
/*
---
copyrights:
...
if(a&&a.removeAllRanges){a.removeAllRanges();}}else{if(document.selection&&document.selection.empty){try{document.selection.empty();}catch(b){}}}}});var Asset={javascript:function(f,c){if(!c){c={};
