...
// Load this file's selection again by visiting: http://mootools.net/more/bf31c1cc6fefc1e3d3f3dc6299ea19b3 
// Or build this file again with packager using: packager build More/Element.Position More/Element.Shortcuts More/Locale
/*
---
copyrights:
...
}return c;},run:function(d){var c=Array.slice(arguments,1);for(var e in d){if(d[e].apply){d[e].apply(d,c);}}return d;}});}).call(this);(function(){var b=null,a={},d={};
